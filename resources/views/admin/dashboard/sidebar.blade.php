    ...
    <div class="p-6">
        ...
        <nav class="space-y-2">
            ...
            <a href="{{ route('admin.badges') }}"
                class="flex items-center gap-3 px-4 py-3 rounded-lg {{ request()->routeIs('admin.badges') ? 'bg-blue-100 text-blue-700 font-semibold' : 'text-gray-700 hover:bg-blue-50' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
