    ...
    <main class="flex-1 p-4 sm:p-6 lg:p-10">
      <div class="bg-white rounded-2xl shadow-xl p-6 sm:p-8 max-w-3xl mx-auto">
        ...
        <div class="text-center sm:text-right">
          <a href="{{ route('review-ulysse') }}" class="inline-block bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded-full font-semibold text-sm transition duration-300">
            I CONFIRM
          </a>
        </div>
      </div>
