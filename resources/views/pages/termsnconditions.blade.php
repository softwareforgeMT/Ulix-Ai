      ...
      <main class="flex-1">
        <div class="bg-white rounded-2xl shadow-lg p-8 md:p-12">
          ...
          <div class="space-y-8">
            ...
            <section id="section1" class="section-card bg-gray-50 rounded-xl p-8 border border-gray-100">
              <div class="flex items-start mb-4">
                ...
                <div>
                  <h2 class="text-2xl font-bold text-blue-700 mb-2">Accepting the terms</h2>
            ...
            <section id="section2" class="section-card bg-white rounded-xl p-8 border border-gray-100 shadow-sm">
              <div class="flex items-start mb-4">
                <div class="w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center text-white font-bold text-xl mr-4 shadow-lg">
                  2
                </div>
                <div>
                  <h2 class="text-2xl font-bold text-blue-700 mb-2">Changes to terms</h2>
                  <div class="w-16 h-1 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full"></div>
                </div>
              </div>
              <p class="text-gray-700 leading-relaxed text-lg pl-16">
            ...
            <section id="section3" class="section-card bg-gray-50 rounded-xl p-8 border border-gray-100">
              <div class="flex items-start mb-4">
                <div class="w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center text-white font-bold text-xl mr-4 shadow-lg">
                  3
                </div>
                <div>
                  <h2 class="text-2xl font-bold text-blue-700 mb-2">Using our product</h2>
                  <div class="w-16 h-1 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full"></div>
                </div>
              </div>
              <p class="text-gray-700 leading-relaxed text-lg pl-16">
            ...
            <section id="section4" class="section-card bg-white rounded-xl p-8 border border-gray-100 shadow-sm">
              <div class="flex items-start mb-4">
                <div class="w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center text-white font-bold text-xl mr-4 shadow-lg">
                  4
                </div>
                <div>
                  <h2 class="text-2xl font-bold text-blue-700 mb-2">General restrictions</h2>
                  <div class="w-16 h-1 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full"></div>
                </div>
              </div>
              <p class="text-gray-700 leading-relaxed text-lg pl-16">
                You may not misuse our services. Fraudulent activity or abuse may result in account suspension.
              </p>
            </section>

            <section id="section5" class="section-card bg-gray-50 rounded-xl p-8 border border-gray-100">
              <div class="flex items-start mb-4">
                <div class="w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center text-white font-bold text-xl mr-4 shadow-lg">
                  5
                </div>
                <div>
                  <h2 class="text-2xl font-bold text-blue-700 mb-2">Content policy</h2>
                  <div class="w-16 h-1 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full"></div>
                </div>
              </div>
              <p class="text-gray-700 leading-relaxed text-lg pl-16">
            ...
            <section id="section6" class="section-card bg-white rounded-xl p-8 border border-gray-100 shadow-sm">
              <div class="flex items-start mb-4">
                <div class="w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center text-white font-bold text-xl mr-4 shadow-lg">
                  6
                </div>
                <div>
                  <h2 class="text-2xl font-bold text-blue-700 mb-2">Your rights</h2>
                  <div class="w-16 h-1 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full"></div>
                </div>
              </div>
              <p class="text-gray-700 leading-relaxed text-lg pl-16">
            ...
            <section id="section7" class="section-card bg-gray-50 rounded-xl p-8 border border-gray-100">
              <div class="flex items-start mb-4">
                <div class="w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center text-white font-bold text-xl mr-4 shadow-lg">
                  7
                </div>
                <div>
                  <h2 class="text-2xl font-bold text-blue-700 mb-2">Copyright policy</h2>
                  <div class="w-16 h-1 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full"></div>
                </div>
              </div>
              <p class="text-gray-700 leading-relaxed text-lg pl-16">
            ...
            <section id="section8" class="section-card bg-white rounded-xl p-8 border border-gray-100 shadow-sm">
              <div class="flex items-start mb-4">
                <div class="w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center text-white font-bold text-xl mr-4 shadow-lg">
                  8
                </div>
                <div>
                  <h2 class="text-2xl font-bold text-blue-700 mb-2">Relationship guidelines</h2>
                  <div class="w-16 h-1 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full"></div>
                </div>
              </div>
              <p class="text-gray-700 leading-relaxed text-lg pl-16">
                All user-provider interactions must remain respectful, professional, and lawful.
              </p>
            </section>

            <section id="section9" class="section-card bg-gray-50 rounded-xl p-8 border border-gray-100">
              <div class="flex items-start mb-4">
                <div class="w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center text-white font-bold text-xl mr-4 shadow-lg">
                  9
                </div>
                <div>
                  <h2 class="text-2xl font-bold text-blue-700 mb-2">Liability Policy</h2>
                  <div class="w-16 h-1 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full"></div>
                </div>
              </div>
              <p class="text-gray-700 leading-relaxed text-lg pl-16">
            ...
            <section id="section10" class="section-card bg-white rounded-xl p-8 border border-gray-100 shadow-sm mb-16">
              <div class="flex items-start mb-4">
                <div class="w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center text-white font-bold text-xl mr-4 shadow-lg">
                  10
                </div>
                <div>
                  <h2 class="text-2xl font-bold text-blue-700 mb-2">General legal terms</h2>
                  <div class="w-16 h-1 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full"></div>
                </div>
              </div>
              <p class="text-gray-700 leading-relaxed text-lg pl-16">
                These terms are governed by applicable international and local laws. Disputes will be resolved via arbitration.
              </p>
            </section>
