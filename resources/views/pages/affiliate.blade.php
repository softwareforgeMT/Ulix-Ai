...
{{-- Show affiliate code or a message --}}
@if($user?->affiliate_code)
  <div class="text-center text-blue-700 font-bold my-4">
    Your affiliate code: {{ $user->affiliate_code }}
  </div>
@else
...
<div class="flex justify-end max-w-7xl mx-auto px-4 mt-6 mb-4">
  <div class="flex items-center bg-gradient-to-r from-blue-500 to-blue-700 rounded-2xl px-6 py-3 shadow-lg space-x-4">
    ...
    <a href="#" class="w-8 h-8 flex items-center justify-center rounded-full bg-white border border-white hover:bg-white transition">
